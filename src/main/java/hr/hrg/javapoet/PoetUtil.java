...
public final class PoetUtil {
    ...
    public static final TypeName TN_CLASS_Q =
    ...
    /**
     * Method that converts Object to TypeName used in other utility
     * methods.<br>
     * Supported types: {@link TypeName}, {@link Type}, {@link TypeMirror},
     * {@link TypeElement}
     *
     * @param type
     *            - any of the supported types (TypeName, Type, TypeMirror,
     *            TypeElement)
     * @return TypeName
     */
    public static TypeName toTypeName(Object type) {
        if (type == null)
        ...
        throw new UnsupportedOperationException("Type " + type + " of " + type.getClass().getName()
                + " not supported for conversion to TypeName");
    }

    /**
     * Method that converts Object to ClassName used in other utility
     * methods.<br>
     * Supported types: {@link TypeName}, {@link Type}, {@link TypeMirror},
     * {@link TypeElement}
     *
     ...
     * @return TypeName
     */
    public static ClassName toClassName(Object type) {
        if (type == null)
            throw new NullPointerException("type can not be null");
        ...
        throw new UnsupportedOperationException("Type " + type + " of " + type.getClass().getName()
                + " not supported for conversion to ClassName");
    }
    ...
    public static AnnotationSpec annotationSpec(
        ...
        return AnnotationSpec.builder(toClassName(type))
                .addMember(member, typeArgumentsFormat, codeParams).build();
    }

    public static TypeSpec.Builder anonymousClassBuilder(
            ModifierBuilder modifiers,
            String typeArgumentsFormat,
            Object... args) {

        TypeSpec.Builder anonymousClassBuilder = TypeSpec.anonymousClassBuilder(typeArgumentsFormat,
                args);
        if (modifiers != null)
            modifiers.to(anonymousClassBuilder);
        return anonymousClassBuilder;
    }

    public static TypeSpec.Builder classBuilder(ModifierBuilder modifiers, String name) {
        TypeSpec.Builder classBuilder = TypeSpec.classBuilder(name);
        if (modifiers != null)
            modifiers.to(classBuilder);
        return classBuilder;
    }

    public static TypeSpec.Builder classBuilder(ModifierBuilder modifiers, ClassName clazz) {
        return classBuilder(modifiers, clazz.simpleName());
    }

    public static TypeSpec.Builder enumBuilder(ModifierBuilder modifiers, String name) {
        TypeSpec.Builder enumBuilder = TypeSpec.enumBuilder(name);
        if (modifiers != null)
            modifiers.to(enumBuilder);
        return enumBuilder;
    }

    public static TypeSpec.Builder enumBuilder(ModifierBuilder modifiers, ClassName name) {
     ...
     *            modifiers
     */
    public static MethodSpec.Builder constructorBuilder(ModifierBuilder modifiers) {
        return modifiers.to(MethodSpec.constructorBuilder());
    }

    /**
     * Shortcut for {@link #methodBuilder(ModifierBuilder, Object, String)} with
     * returnsType=void.
     *
     * @param modifiers
     *            modifiers
     ...
     */
    public static MethodSpec.Builder methodBuilder(ModifierBuilder modifiers, String name) {
     ...
     *            modifiers
     * @param returnsType
     *            - return type of the method (any definition supported by
     *            {@link #toTypeName(Object)}
     * @param name
     *            - method name
     * @return {@link MethodSpec.Builder}
     */
    public static MethodSpec.Builder methodBuilder(
            ModifierBuilder modifiers,
            Object returnsType,
            String name) {
        MethodSpec.Builder b = MethodSpec.methodBuilder(name).returns(toTypeName(returnsType));
        if (modifiers != null)
            b.addModifiers(modifiers.toArray());
        return b;
    }

    // *********************** addConstructor **************************
    public static void addConstructor(TypeSpec.Builder builder, MethodCustomizer customizer) {
    ...
    public static void addMethod(
            ...
            Object type,
            String name,
            MethodCustomizer customizer) {

        customizeAndAddMethod(builder, null,
                MethodSpec.methodBuilder(name).returns(toTypeName(type)), customizer);
    }
    ...
    public static void addMethod(
        ...
        customizeAndAddMethod(builder, modifiers,
                MethodSpec.methodBuilder(name).returns(toTypeName(type)), customizer);
    }
    ...
    private static void customizeAndAddMethod(
            TypeSpec.Builder builder,
            ModifierBuilder modifiers,
    ...
    public static void addParameter(MethodSpec.Builder builder, Object type, String name) {
    ...
    public static void addParameter(
        ...
        customizeAndAddParam(builder, null, ParameterSpec.builder(toTypeName(type), name),
                customizer);
    }
    ...
    public static void addParameter(
        ...
        customizeAndAddParam(builder, modifiers, ParameterSpec.builder(toTypeName(type), name),
                customizer);
    }
    ...
    public static void addBeanField(
        ...
        if (withGetter) {
            ...
            getter = MethodSpec.methodBuilder(methondName).addModifiers(Modifier.PUBLIC)
                    .returns(type);
        ...
        if (customizer != null)
            customizer.customize(field, getter, setter);

        cb.addField(field.build());

        if (withGetter)
            cb.addMethod(getter.build());
        if (withSetter)
            cb.addMethod(setter.build());
    }

    // *********************** addField *********************************************
    // type,name
    public static FieldSpec addField(TypeSpec.Builder cb, Object type, String name) {
        return customizeAndAdd(cb, null, FieldSpec.builder(toTypeName(type), name), null);
    }

    // type,name,initializerFormat,formatParams
    public static FieldSpec addField(
            TypeSpec.Builder cb,
            Object type,
            String name,
            String initializerFormat,
            Object... formatParams) {
        return customizeAndAdd(cb, null, FieldSpec.builder(toTypeName(type), name)
                .initializer(initializerFormat, formatParams), null);
    }
    ...
    public static FieldSpec addField(
            ...
            String initializerFormat,
            Object... formatParams) {
        return customizeAndAdd(cb, modifiers, FieldSpec.builder(toTypeName(type), name)
                .initializer(initializerFormat, formatParams), null);
    }
    ...
    private static FieldSpec customizeAndAdd(
            TypeSpec.Builder cb,
            ModifierBuilder modifiers,
    ...
    public static ModifierBuilder NO_MODIFIER() {
        return new ModifierBuilder();
    }

    public static ModifierBuilder ABSTRACT() {
        return new ModifierBuilder(Modifier.ABSTRACT);
    }

    public static ModifierBuilder DEFAULT() {
        return new ModifierBuilder(Modifier.DEFAULT);
    }

    public static ModifierBuilder FINAL() {
        return new ModifierBuilder(Modifier.FINAL);
    }

    public static ModifierBuilder NATIVE() {
        return new ModifierBuilder(Modifier.NATIVE);
    }

    public static ModifierBuilder PRIVATE() {
        return new ModifierBuilder(Modifier.PRIVATE);
    }

    public static ModifierBuilder PROTECTED() {
        return new ModifierBuilder(Modifier.PROTECTED);
    }

    public static ModifierBuilder PUBLIC() {
        return new ModifierBuilder(Modifier.PUBLIC);
    }

    public static ModifierBuilder STATIC() {
        return new ModifierBuilder(Modifier.STATIC);
    }

    public static ModifierBuilder STRICTFP() {
        return new ModifierBuilder(Modifier.STRICTFP);
    }

    public static ModifierBuilder SYNCHRONIZED() {
        return new ModifierBuilder(Modifier.SYNCHRONIZED);
    }

    public static ModifierBuilder TRANSIENT() {
        return new ModifierBuilder(Modifier.TRANSIENT);
    }

    public static ModifierBuilder VOLATILE() {
        return new ModifierBuilder(Modifier.VOLATILE);
    }
